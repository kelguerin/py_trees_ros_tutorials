...
.. code-block:: bash
   ...
   $ py-trees-render -b hugr.one_data_gathering.tutorial_create_root

.. graphviz:: dot/tutorial-one-data-gathering.dot
   :align: center

.. literalinclude:: ../hugr/one_data_gathering.py
   :language: python
   :linenos:
   :lines: 121-153
...
.. code-block:: bash
    ...
    # Launch the tutorial
    $ ros2 launch hugr tutorial_one_data_gathering_launch.py
