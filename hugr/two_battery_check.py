...
.. code-block:: bash
   ...
   $ py-trees-render -b hugr.two_battery_check.tutorial_create_root

.. graphviz:: dot/tutorial-two-battery-check.dot
   :align: center

.. literalinclude:: ../hugr/two_battery_check.py
   :language: python
   :linenos:
   :lines: 122-166
...
This tree makes use of the :class:`hugr.behaviours.FlashLedStrip` behaviour.

.. literalinclude:: ../hugr/behaviours.py
   :language: python
   :linenos:
   :lines: 29-110
...
.. code-block:: bash
    ...
    $ ros2 launch hugr tutorial_two_battery_check_launch.py
