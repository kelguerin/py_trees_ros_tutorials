...
.. code-block:: bash
   ...
   $ py-trees-render -b hugr.five_action_clients.tutorial_create_root

.. graphviz:: dot/tutorial-five-action-clients.dot
   :align: center

.. literalinclude:: ../hugr/five_action_clients.py
   :language: python
   :linenos:
   :lines: 208-307
...
.. code-block:: bash
    ...
    $ ros2 launch hugr tutorial_five_action_clients_launch.py
