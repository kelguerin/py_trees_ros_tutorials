...
.. code-block:: bash
   ...
   $ py-trees-render -b hugr.eight_dynamic_application_loading.tutorial_create_root

.. graphviz:: dot/tutorial-eight-core-tree.dot
   :align: center
   :caption: hugr.eight_dynamic_application_loading.tutorial_create_root
...
.. code-block:: bash
   ...
   $ py-trees-render --with-blackboard-variables hugr.eight_dynamic_application_loading.tutorial_create_scan_subtree

.. graphviz:: dot/tutorial-eight-application-subtree.dot
   :align: center
   :caption: hugr.eight_dynamic_application_loading.tutorial_create_scan_subtree

Dynamic Application Tree (Class)
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. literalinclude:: ../hugr/eight_dynamic_application_loading.py
   :language: python
   :linenos:
   :lines: 380-384
...
.. code-block:: bash
    ...
    # Launch the tutorial
    $ ros2 launch hugr tutorial_eight_dynamic_application_loading_launch.py
