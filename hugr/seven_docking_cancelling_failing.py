...
.. code-block:: bash
   ...
   $ py-trees-render -b hugr.seven_docking_cancelling_failing.tutorial_create_root

.. graphviz:: dot/tutorial-seven-docking-cancelling-failing.dot
   :align: center

.. literalinclude:: ../hugr/seven_docking_cancelling_failing.py
   :language: python
   :linenos:
   :lines: 211-398
...
.. code-block:: bash
    ...
    # Launch the tutorial
    $ ros2 launch hugr tutorial_seven_docking_cancelling_failing_launch.py
    # In another shell
